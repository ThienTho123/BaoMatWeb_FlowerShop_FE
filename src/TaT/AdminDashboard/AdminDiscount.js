...
const AdminDiscount = () => {
  ...
  const handleDeleteHard = async (id) => {
    try {
      ...
      if (response.ok) {
        setDiscountList((prev) =>
          prev.filter((discount) => discount.discountID !== id)
        );
      } else {
  ...
  const handleSave = async (id, discountData) => {
    try {
      ...
      const formattedData = {
        ...
        categories:
          discountData.categories && discountData.categories.categoryID
      ...
      console.log(
        `JSON gửi đi khi cập nhật giảm giá ID ${id}:`,
      ...
      prev.map((discount) =>
        discount.discountID === id
          ? {
              ...
              purpose:
                field === "purpose" ? { purposeID: value } : discount.purpose,
            }
          : discount
      )
    );
    ...
    <div className="admin-ql-container">
      ...
      <div>
        ...
        <select
          ...
          disabled={
            newDiscount.categoryID.categoryID || newDiscount.purpose.purposeID
          }
        >
        ...
        <select
          ...
          disabled={
            newDiscount.categoryID.categoryID || newDiscount.type.typeID
          }
        >
                ...
                <td>
                  {editingDiscountId === discount.discountID ? (
                    <select
                      ...
                      disabled={
                        discount.type?.typeID || discount.purpose?.purposeID
                      } // Khoá khi có dữ liệu trong Loại hoặc Mục Đích
                    >
                      <option value="">Chọn Danh Mục</option>
                      {categories.map((category) => (
                        <option
                  ...
                  {editingDiscountId === discount.discountID ? (
                    <select
                      ...
                      disabled={
                        ...
                        discount.purpose?.purposeID
                      } // Khoá khi có dữ liệu trong Danh Mục hoặc Mục Đích
                    >
                      <option value="">Chọn Loại</option>
                      {types.map((type) => (
                        <option key={type.typeID} value={type.typeID}>
                ...
                <td>
                  {editingDiscountId === discount.discountID ? (
                    <select
                      ...
                      disabled={
                        discount.categoryID?.categoryID || discount.type?.typeID
                      } // Khoá khi có dữ liệu trong Danh Mục hoặc Loại
                    >
                      <option value="">Chọn Mục Đích</option>
                      {purposes.map((purpose) => (
                        <option
                ...
                <td>
                  {editingDiscountId === discount.discountID ? (
                    <>
                      <button
                        onClick={() =>
                          handleSave(discount.discountID, discount)
                        }
                      >
                        Lưu
                      </button>
                    ...
                    <>
                      <button
                        onClick={() => handleEditRow(discount.discountID)}
                      >
                        Chỉnh sửa
                      </button>
                      <button
                        onClick={() => handleDeleteSoft(discount.discountID)}
                      >
                        Vô hiệu
                      </button>
                    </>
