...
const StaffFlowerSize = () => {
  ...
  useEffect(() => {
    const fetchFlowerSizes = async () => {
      try {
        const response = await fetch(
          "https://localhost:8080/api/v1/staff/flowersize",
          {
            headers: {
    ...
    const fetchFlowerOptions = async () => {
      try {
        const response = await fetch(
          "https://localhost:8080/api/v1/staff/flower",
          {
            headers: {
              Authorization: `Bearer ${accesstoken}`,
            },
  ...
  const handleSave = async (id) => {
    ...
    try {
      const response = await fetch(
        `https://localhost:8080/api/v1/staff/flowersize/${id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
  ...
  const handleDeleteSoft = async (id) => {
    try {
      const response = await fetch(
        `https://localhost:8080/api/v1/staff/flowersize/softdelete/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${accesstoken}`,
